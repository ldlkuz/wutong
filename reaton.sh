    ...
    case $main in
        ...
        4) 
            ...
            do
                ...
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    ...
                    echo "\033[34mA. 解除第三方安装限制\033[0m"
                    echo "\033[34mB. 恢复第三方安装限制\033[0m"
                    # 读取用户输入
                    read -p "$(LANG=C echo '\033[33m按请输入选项：\033[0m')" choice
                    choice=$(echo $choice | tr '[:lower:]' '[:upper:]')
                    case $choice in
                        "A")
                           echo "adb36987" | adb shell "cd /system/app/deCoreAppUser && mv deCoreAppUser.apk deCoreAppUser.bak "
                           ;;
                        "B")
                           echo "adb36987" | adb shell "cd /system/app/deCoreAppUser && mv deCoreAppUser.bak deCoreAppUser.apk "
                           ;;
                        *)
        ...
        5) 
            ...
            do
                ...
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    ...
                    echo "adb36987" | adb shell rm -rf /system/priv-app/Auto
        ...
        6)
            ...
            do
                ...
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    ...
                    echo "adb36987" | adb shell mkdir /system/priv-app/Auto
                    echo "adb36987" | adb shell mkdir /data/gaodetmp
                    adb push /sdcard/changan/Auto/lib.tar.gz /data/gaodetmp
                    echo "adb36987" | adb shell "cd /data/gaodetmp && tar -zxvf lib.tar.gz && mv lib /system/priv-app/Auto"
                    adb push /sdcard/changan/Auto/Auto.apk /system/priv-app/Auto
                    rm -rf /data/gaodetmp
                    read -p "$(LANG=C echo '\033[32m按回车键重启车机\033[0m')" key
                    adb reboot
                    clear
        ...
        8) 
            ...
            do
                ...
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    ...
                    echo "\033[32m删除成功，按回车键重启车机\033[0m"
                    adb reboot
                    clear
                    break
                else
        ...
        9) 
            ...
            do
                ...
                result=$(adb devices | grep $ip)
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    echo "\033[34m禁用自带亿联投屏----\033[0m"
                    echo "adb36987" | adb shell "cd /system/app/EasyConnect && mv EasyConnect.apk EasyConnect.bak"
                    echo "adb36987" | adb shell "cd /system/app/YiLlianTouPing && mv YiLlianTouPing.apk YiLlianTouPing.bak"
                    sleep 2
                    echo "\033[34m更新公版亿联投屏----\033[0m"
                    echo "adb36987" | adb shell mkdir /data/yilianlib
                    echo "adb36987" | adb shell mkdir /system/app/yl
                    adb push /sdcard/changan/yl/lib.tar.gz /data/yilianlib
                    echo "adb36987" | adb shell "cd /data/yilianlib && tar -zxvf lib.tar.gz"
                    echo "adb36987" | adb shell mv /data/yilianlib/lib /system/app/yl
                    adb push /sdcard/changan/yl/yl.apk /system/app
                    echo "\033[34m等待20秒----\033[0m"
                    sleep 10
                    adb push /sdcard/changan/yl/ryl.apk /system/app
                    sleep 10
                    echo "adb36987" | adb shell mv /system/app/yl.apk /system/app/yl
                    sleep 2
                    echo "adb36987" | adb shell mv /system/app/ryl.apk /system/app
                    sleep 2
                    read -p "$(LANG=C echo '\033[33m按回车键重启车机\033[0m')" key
                    echo "adb36987" | adb shell rm -rf /data/yilianlib
                    adb reboot
                    clear
                    break
                else
        ...
        c)
            ...
            do
                ...
                if [ $? -eq 0 ] && [ "$result" != "" ]; then
                    ...
                    case $choice in
                        "N")
                           echo "adb36987" | adb shell mv /system/app/Fota/Fota.apk /system/app/Fota/Fota.bak
                           ;;
                        "Y")
                           echo "adb36987" | adb shell mv /system/app/Fota/Fota.bak /system/app/Fota/Fota.apk
                           ;;
                        *)
                           echo "\033[34m无效选择\033[0m"
                           ;;
